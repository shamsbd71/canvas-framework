 ...
 * @since       11.1
 */
class JDocumentRendererCANVASAjax extends JDocumentRenderer
{
	/**
	...
	public function render($info, $params = array(), $content = null)
	{
		...
		$task = $input->getCmd('canvasajax', 'position');
	...
	{		
		...
		if($module && $module->id){
			$buffer = JModuleHelper::renderModule($module, array('style'=> $input->getCmd('style', 'CANVASXhtml')));
		}
