		...
		switch (strtolower($type))
		{
			case 'template':
				...
				if (isset($app))
				{
					...
					//if it is CANVAS template, update search path for template
					$this->_addPath('template', CANVAS_PATH . '/html/' . $component . '/' . $this->getName());

					$fallback = JPATH_THEMES . '/' . $app->getTemplate() . '/html/' . $component . '/' . $this->getName();
					$this->_addPath('template', $fallback);

					//search path for user custom folder
					if (!defined('CANVAS_LOCAL_DISABLED')) $this->_addPath('template', CANVAS_LOCAL_PATH . '/html/' . $component . '/' . $this->getName());
