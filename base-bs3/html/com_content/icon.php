...
abstract class JHtmlIcon
{
	...
	public static function create($category, $params, $attribs = array(), $legacy = false)
	{
		...
		$output = '<span class="hasTooltip" title="' . CANVASJ::tooltipText('COM_CONTENT_CREATE_ARTICLE') . '">' . $button . '</span>';
	...
	public static function edit($article, $params, $attribs = array(), $legacy = false)
	{
		...
		if (property_exists($article, 'checked_out') && property_exists($article, 'checked_out_time') && $article->checked_out > 0 && $article->checked_out != $user->get('id'))
		{
			...
			return '<span class="hasTooltip" title="' . CANVASJ::tooltipText($tooltip. '', 0) . '">' . $button . '</span>';
		}
		...
		else
		{
			...
			$text = '<span class="hasTooltip fa fa-' . $icon . ' tip" title="' . CANVASJ::tooltipText(JText::_('COM_CONTENT_EDIT_ITEM'), $overlib, 0) . '"></span>&#160;' . JText::_('JGLOBAL_EDIT') . '&#160;';
		}
