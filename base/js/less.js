...
function createCSS(styles, sheet, lastModified) {
	...
	/* CANVAS framework: add to the sheet position inteads of at the end of head */
...
function xhr(url, type, callback, errback) {
    ...
    function canvasPreprocess (xhr, url) {
        ...
        if(
            ...
            url.indexOf('canvas/base') == -1                                    //this file must not be in canvas/base folder
            ){
